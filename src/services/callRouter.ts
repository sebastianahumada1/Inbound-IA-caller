 ...
 */
function buildFullPhone(lead: HotProspectorLead, fallback: string): string {
...
export function decideCallRoute(
  ...
  const fallbackAssistantId =
    process.env.VAPI_ASSISTANT_FALLBACK_ID ?? defaultAssistantId;
...
export async function scheduleAppointment(
  ...
  return {
    ok: false,
    message:
      "scheduleAppointment stub – implement real logic when requirements are finalised",
  };
}
